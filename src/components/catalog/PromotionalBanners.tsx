...
export const PromotionalBanners = ({ isMayorista = false }: PromotionalBannersProps) => {
  return (
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-amber-400 to-orange-500 rounded-2xl p-8 text-center text-white">
            <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">
              {isMayorista ? '¡Suscríbete y obtén ofertas exclusivas mayoristas!' : '¡Suscríbete y obtén 15% OFF en tu primer pedido!'}
            </h2>
            <p className="text-amber-100 mb-6 max-w-2xl mx-auto">
              {isMayorista 
                ? 'Recibe promociones especiales para mayoristas, nuevos productos y descuentos por volumen directamente en tu email.'
                : 'Recibe ofertas exclusivas, nuevos sabores y promociones especiales directamente en tu email.'
              }
            </p>
            ...
            <p className="text-xs text-amber-100 mt-3">
              {isMayorista ? '* Promoción válida solo para mayoristas registrados' : '* Promoción válida solo para nuevos suscriptores'}
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl p-6 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-pink-100 mb-4">
                  {isMayorista 
                    ? 'Ve nuestros productos mayoristas, casos de éxito y testimonios de distribuidores.'
            ...
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-6 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-green-100 mb-4">
                  {isMayorista 
                    ? 'Asesoría especializada para mayoristas, pedidos grandes y atención personalizada.'
          ...
          <div className="bg-gradient-to-r from-purple-100 to-indigo-100 rounded-xl p-8 text-center">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl font-display font-bold text-stone-800 mb-4">
                {isMayorista ? '🏆 Programa de Mayoristas VIP' : '🏆 Programa de Clientes Frecuentes'}
              </h2>
              <p className="text-stone-600 mb-6">
                {isMayorista 
                  ? 'Beneficios exclusivos para mayoristas: descuentos progresivos, crédito comercial y atención prioritaria.'
                  : 'Acumula puntos con cada compra y canjéalos por descuentos, productos gratuitos y beneficios exclusivos.'
                }
              </p>
              <div className="grid sm:grid-cols-3 gap-4 mb-6">
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  <div className="text-2xl mb-2">{isMayorista ? '🎯' : '🎯'}</div>
                  <h4 className="font-semibold text-stone-800 mb-1">
                    {isMayorista ? 'Descuentos por volumen' : 'Acumula puntos'}
                  </h4>
                  <p className="text-xs text-stone-600">
                    {isMayorista ? 'Hasta 25% descuento en pedidos grandes' : '1 punto por cada S/ 10 gastado'}
                  </p>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  <div className="text-2xl mb-2">🎁</div>
                  <h4 className="font-semibold text-stone-800 mb-1">
                    {isMayorista ? 'Crédito comercial' : 'Canjea premios'}
                  </h4>
                  <p className="text-xs text-stone-600">
                    {isMayorista ? 'Facilidades de pago para mayoristas' : '100 puntos = S/ 10 de descuento'}
                  </p>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm">
                  <div className="text-2xl mb-2">⭐</div>
                  <h4 className="font-semibold text-stone-800 mb-1">
                    {isMayorista ? 'Atención VIP' : 'Beneficios VIP'}
                  </h4>
                  <p className="text-xs text-stone-600">
                    {isMayorista ? 'Soporte dedicado y asesor personal' : 'Acceso a ofertas exclusivas'}
                  </p>
                </div>
              </div>
              <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold">
                {isMayorista ? 'Ver beneficios VIP' : 'Unirme al programa'}
              </button>
            </div>
          </div>
        </div>
