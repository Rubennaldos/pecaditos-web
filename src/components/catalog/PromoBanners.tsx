      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-600">
            {isMayorista
              ? "Todo lo que necesitas saber sobre compras mayoristas y nuestro servicio exclusivo para negocios."
              : "Todo lo que necesitas saber sobre nuestros productos y servicios"}
          </p>
        </div>

        <Accordion type="single" collapsible className="space-y-4">
          {/* Puedes agregar FAQ específicas solo para mayoristas si quieres */}
          {isMayorista && (
            <AccordionItem value="mayorista-benefits" className="border border-blue-200 rounded-lg px-4">
              <AccordionTrigger className="text-left font-semibold text-blue-800">
                🏢 ¿Qué ventajas tengo como cliente mayorista?
              </AccordionTrigger>
              <AccordionContent className="text-blue-600 pt-2">
                <div className="space-y-3">
                  <p>
                    Precios exclusivos con descuentos por volumen, atención personalizada, facturación empresarial, 
                    envíos programados y soporte especial para negocios.
                  </p>
                  <p>
                    Consulta por combos personalizados, condiciones especiales o cotizaciones a medida.
                  </p>
                </div>
              </AccordionContent>
            </AccordionItem>
